...
exports.getVarInt32Array = void 0;
 ...
 */
function getVarInt32Array(genericDecoder, buf) {
    ...
    for (var index = 0; index < nbEntries; index++) {
        var decodedValue = (0, integer_1.getVarInteger)(genericDecoder, data.buffer, 0);
...
exports.getVarInt32Array = getVarInt32Array;
