...
exports.getVarFloat32Array = void 0;
 ...
 */
function getVarFloat32Array(genericDecoder, buf) {
    ...
    for (var index = 0; index < nbEntries; index++) {
        var decodedValue = (0, float_1.getVarFloat)(genericDecoder, data.buffer, 0);
...
exports.getVarFloat32Array = getVarFloat32Array;
